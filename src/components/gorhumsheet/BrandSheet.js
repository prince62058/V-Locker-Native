...
const BrandSheet = forwardRef(({ selected, onSelect, handleSheetChanges }, ref) => {
    ...
    const Option = ({ item }) => {
        const isSelected = selected?.brandName === item?.brandName
        ...
        >
            ...
            <BottomSheetFlatList
                ...
                contentContainerStyle={
                    (brandData?.data?.length ? styles.listContent : styles.emptyList)
                }
            />
        </BottomSheetModal>
    )
