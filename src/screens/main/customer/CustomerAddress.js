...
import { BackHandler, Keyboard, KeyboardAvoidingView, Platform, RefreshControl, ScrollView, StyleSheet, View } from 'react-native'
...
const CustomerAddress = ({ navigation }) => {
    ...
    const handleCreatePress = async () => {
        ...
        const updatedFields = Object.entries(form).reduce((acc, [key, value]) => {
            ...
            if (key === 'customerState' && typeof value === 'object' && value?.stateName) {
                processedValue = value.stateName;
            }
            if (key === 'customerCity' && typeof value === 'object' && value?.cityName) {
                ...
                >
                    <View style={styles.container}>
                        ...
                        <MainText style={{
                            ...
                            marginVertical: 15,
                            fontFamily: FONTS.medium
                        }}>Relative Contact info</MainText>
