                ...
                <View style={styles.toggleButton}>
                    ...
                    >
                        ...
                        <View
                            style={[
                                ...
                                { backgroundColor: activeToggle === 'loans' ? COLORS.primary : COLORS.border },
                            ]}
                        />
                    </Pressable>
                    ...
                    >
                        ...
                        <View
                            style={[
                                styles.activeIndicator,
                                { backgroundColor: activeToggle === 'documents' ? COLORS.primary : COLORS.border },
                            ]}
                        />
                    </Pressable>
                </View>
            ...
            {activeToggle === 'loans' && <View>
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            <Pressable onPress={() => console.log('status Button Press...')}
                                style={[styles.statusBox, { backgroundColor: statusStyle.backgroundColor }]}
                            >
                                <MainText style={styles.statusText}>{item.status}</MainText>
                            </Pressable>
                        )
                    }}
                    contentContainerStyle={{ paddingHorizontal: SIZES.width * 0.05, marginBottom: fontSize(5) }}
                    ItemSeparatorComponent={() => <View style={{ width: SIZES.width * 0.022 }} />}
                />
            </View>
            }
            <View style={styles.mainStyle}>
                ...
                {activeToggle === 'documents' &&
                    <View style={styles.View}>
                        <PressableView title="Complete Aadhar KYC" onPress={() => navigation.navigate('Aadhar', { customerId: id })} />
                        <PressableView title="Complete Pan KYC" onPress={() => navigation.navigate('Pan', { customerId: id })} />
                        <PressableView title="Add Bank Passbook Photo" onPress={() => navigation.navigate('Passbook', { customerId: id })} />
                        <PressableView title="Add Customer Address" onPress={() => navigation.navigate('CustomerAddress', { customerId: id })} />
                    </View>
