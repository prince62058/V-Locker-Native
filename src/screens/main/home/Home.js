...
import { saveFCMThunk, userProfile } from '../../../redux/slices/auth/authSlice'
...
const Home = ({ navigation }) => {
    ...
    const handlePermission = async () => {
        ...
        const response = await dispatch(saveFCMThunk({ pushNotificationToken: fcmToken }))
        ...
        <MainView transparent={false}>
            ...
            >
                <View style={styles.flexView}>
                    <StatsCard
                        onPress={() => navigation.navigate('DeviceList', { title: 'Enrolled Devices', })}
                        icon={icons.enrolled}
                    ...
                    />
                    <StatsCard
                        onPress={() => navigation.navigate('DeviceList', { title: 'Not Active Devices', key: 'notActiveDevices' })}
                        icon={icons.noActive}
                ...
                <View style={styles.flexView}>
                    <StatsCard
                        ...
                        bgColor={COLORS.red}
                        onPress={() => navigation.navigate('DeviceList', { title: 'Deactivated Devices', key: 'deactivateDevices' })}
                    />
                    <StatsCard
                        icon={icons.locked}
                        ...
                        onPress={() => navigation.navigate('DeviceList', { title: 'Locked Devices', key: 'lockedDevices' })}
                    />
                </View>
                ...
                <View style={styles.container}>
                    <LoanCard
                        ...
                        onPress={() => navigation.navigate('DeviceList', { title: 'All Loans', filter: true })}
                    />
                    <LoanCard
                        text={'Loans (Running Device)'}
                        icon={icons.loans}
                        gradientColors={[COLORS.lg02, COLORS.lg12]}
                        onPress={() => navigation.navigate('DeviceList', { title: 'Loans (Running Device)', key: 'runningDevice' })}
                    />
                    <LoanCard
                        text={'Loans (New Device)'}
                        icon={icons.newLoans}
                        gradientColors={[COLORS.lg03, COLORS.lg13]}
                        onPress={() => navigation.navigate('DeviceList', { title: 'Loans (New Device)', key: 'newDevice' })}
                    />
                    <LoanCard
                        text={'All Customers'}
                        icon={icons.allCustomers}
                        gradientColors={[COLORS.lg04, COLORS.lg14]}
                        onPress={() => navigation.navigate('CutomerList', { title: 'Customers' })}
                    />
                    <LoanCard
