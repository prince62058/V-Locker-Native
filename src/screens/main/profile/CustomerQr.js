...
const CustomerQr = ({ navigation }) => {
  ...
  const provisioningPayload = JSON.stringify({
    ...
    'android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_DOWNLOAD_LOCATION':
      'https://example.com/vlocker-release.apk', // TODO: Replace with Real URL
    'android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM': 'AgRwHg...', // TODO: Replace with Real Checksum
